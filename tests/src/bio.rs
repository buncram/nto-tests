...
impl TestRunner for BioTests {
    fn run(&mut self) {
        ...
        iox.set_gpio_pullup(bao1x_api::iox::IoxPort::PB, 2, bao1x_api::iox::IoxEnable::Enable);
        iox.set_gpio_pullup(bao1x_api::iox::IoxPort::PB, 3, bao1x_api::iox::IoxEnable::Enable);
